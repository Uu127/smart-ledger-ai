                    ...
                    <div className="grid grid-cols-2 gap-2">
                        {DOC_TYPES.map(t => (
                            <button key={t} type="button" onClick={() => setType(t)}
                                className={`py-3 rounded-xl text-sm font-black transition-all active:scale-95 border-2 ${type === t ? "border-emerald-400 bg-emerald-50 text-emerald-700" : "border-slate-100 bg-slate-50 text-slate-500"
                                    }`}>
                                    ...
                                    <div className="relative">
                                        ...
                                        {taxIncMode ? (
                                            <input type="number" inputMode="numeric" min={0}
                                                placeholder="0"
                                                min={0}
                                                onChange={e => handleTaxIncPrice(item.id, Number(e.target.value) || 0, item.taxRate)}
